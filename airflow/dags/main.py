...
import sql.create_table as create_table
...
with DAG(
    ...
    task_warehouse = SparkSubmitOperator(
        ...
        # conf={
        #     'spark.jars': '/opt/jars/spark-snowflake_2.12-2.12.0-spark_3.4.jar,/opt/jars/snowflake-jdbc-3.19.0.jar'
        # },
        conn_id = 'spark_default'
    )

task_bronze >> task_silver >> [task_gold, task_check_data_silver]

[task_gold, tg_create_table] >> task_warehouse